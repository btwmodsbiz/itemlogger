 ...
 * Otherwise, displays a friendly message giving the user instructions on how to proceed.
...
<title>Yii Framework Missing</title></head><body>

<h1>Yii Framework Missing</h1>
<p>The Yii framework could not be loaded<?php if (!is_array($local)) { ?>, and is required to install this application<?php } ?>.</p>
<h2>Installing the Yii Framework:</h2>
	<ol>
		...
		<li>Copy that directory into this application's directory.</li>
	</ol>
<h2>Using Your Existing Installation of the Yii Framework:</h2>
	<ol>
		<li>Create a file named <code>web-local.php</code> within the <code>protected/config</code> directory in your application directory.</li>
